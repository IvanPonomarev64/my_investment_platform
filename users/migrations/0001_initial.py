    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('IN', 'Инвестор'), ('BR', 'Заемщик')], max_length=2, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revenue_year', models.IntegerField(verbose_name='Выручка за год')),
                ('profit_year', models.IntegerField(verbose_name='Доход за год')),
